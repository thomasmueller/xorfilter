...
git clone https://github.com/thomasmueller/xorfilter_cpp.git
...
scp ...:~/xorfilter_cpp/benchmarks/results-2018-10-17-softiron1000.txt .
    ...
    void printInsertTimes() {
        ...
        while(true) {
            ...
            for(Data d : data) {
                ...
                printData(d.keysMillions, nanosPerKey(d.add));
            }
            printEnd(name);
        }
    }
